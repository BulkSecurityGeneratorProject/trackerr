        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.userService.find(id).subscribe((user) => {
                    user.createdDate = this.datePipe
                        .transform(user.createdDate, 'yyyy-MM-ddTHH:mm:ss');
                    user.lastModifiedDate = this.datePipe
                        .transform(user.lastModifiedDate, 'yyyy-MM-ddTHH:mm:ss');
