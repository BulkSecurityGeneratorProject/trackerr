...
export class TaskService {
    ...
    findForCurrUserAndProject(id: number): Observable<ResponseWrapper> {
        return this.http.get(`${this.resourceUrl}/project/${id}`).map((res: Response) =>        this.convertResponse(res)     );
