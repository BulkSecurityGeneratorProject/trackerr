...
public class TaskResourceIntTest {
    ...
    private static final String DEFAULT_TASK_DESCR = "AAAAAAAAAA";
    private static final String UPDATED_TASK_DESCR = "BBBBBBBBBB";
    ...
    public void setup() {
        ...
        final TaskResource taskResource = new TaskResource(taskRepository,userRepository);
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getTaskDescr()).isEqualTo(DEFAULT_TASK_DESCR);
    }
    ...
    public void getAllTasks() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].taskDescr").value(hasItem(DEFAULT_TASK_DESCR.toString())));
    }
    ...
    public void getTask() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks/{id}", task.getId()))
            ...
            .andExpect(jsonPath("$.taskDescr").value(DEFAULT_TASK_DESCR.toString()));
    }
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getTaskDescr()).isEqualTo(UPDATED_TASK_DESCR);
    }
